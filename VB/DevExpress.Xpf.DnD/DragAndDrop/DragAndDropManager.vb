...
Namespace DX.Xpf.DnD
	Public NotInheritable Class DragAndDropManager
		Private Class DragAndDropHelper
            ...
            Public Function IsCompatibleDropTargetFactory(ByVal factory As IDropTargetFactory, ByVal dropTargetElement As UIElement) As Boolean Implements ISupportDragDrop.IsCompatibleDropTargetFactory
                Return True
            End Function
        ...
        Private Shared Sub OnAllowDragChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)
            Dim source As FrameworkElement = TryCast(d, FrameworkElement)
        ...
        Public Shared ReadOnly AllowDropProperty As DependencyProperty = DependencyProperty.RegisterAttached("AllowDrop", GetType(Boolean), GetType(DragAndDropManager), New PropertyMetadata(False, New PropertyChangedCallback(AddressOf OnAllowDropChanged)))
