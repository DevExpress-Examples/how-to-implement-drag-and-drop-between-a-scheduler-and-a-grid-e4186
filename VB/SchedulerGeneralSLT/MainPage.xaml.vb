	...
	Partial Public Class MainPage
		...
		Public Sub scheduler_Drop(ByVal sender As Object, ByVal e As DragAndDropEventArgs)
			...
			If vsivi IsNot Nothing Then
				...
				For i As Integer = 0 To dragData.Count - 1
					CType(gridControl1.ItemsSource, IList).Remove(dragData(i))
					Dim apt As Appointment = ScheduleTaskToAppointment(TryCast(dragData(i), ScheduleTask))
